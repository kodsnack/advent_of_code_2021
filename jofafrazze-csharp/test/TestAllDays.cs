...
namespace test
{
    ...
    {
        [Fact]
        public void Example() => Assert.Equal((4140, 3993), aoc.Day18.DoPuzzle(Input.example));
        [Fact]
        public void Test() => Assert.Equal((3494, 4712), aoc.Day18.DoPuzzle(Input.actual));
    }
    ...
    {
        [Fact]
        public void Example() => Assert.Equal((12521, 44169), aoc.Day23.DoPuzzle(Input.example));
        [Fact]
        public void Test() => Assert.Equal((11516, 40272), aoc.Day23.DoPuzzle(Input.actual));
    }
